...
/**
 * @program 使用Statement.executeLargeUpdate接口实现数据新增
 * @description
 * @author mutisitic
 * @date 2018年9月26日
 */
public class ExecuteLargeUpdateByInsert {
	/**
	 * @description 使用Statement.executeLargeUpdate接口实现数据新增
	 * @author mutisitic
	 * @date 2018年9月26日
	 * @param statement
	 * @throws SQLException
	...
	/**
	 * @description 使用 Statement.executeLargeUpdate(String sql)：数据新增
	 * @author mutisitic
	 * @date 2018年9月26日
	 * @param statement
	 * @throws SQLException
	...
	/**
	 * @description 使用  Statement.executeLargeUpdate(String sql, int autoGeneratedKeys)：数据新增
	 * @author mutisitic
	 * @date 2018年9月26日
	 * @param statement
	 * @throws SQLException
	...
	/**
	 * @description 使用  Statement.executeLargeUpdate(String sql, int[] columnIndexes)：数据新增
	 * @author mutisitic
	 * @date 2018年9月26日
	 * @param statement
	 * @throws SQLException 
	...
	/**
	 * @description 使用  Statement.executeLargeUpdate(String sql, String[] columnNames)：数据新增
	 * @author mutisitic
	 * @date 2018年9月26日
	 * @param statement
	 * @throws SQLException 
